...
let xx = new AtomType(scatCromerMannCoeffs['Xx'], scatHiAngFoxCoeffs['Xx'])
qc.setAtomType('Xx', xx)

qc.setAtomSite('Xx1', [0, 0])

let beta = qc.genADTensorBetaNoPhasonFromUCartn([0, 0, 0, 0])
...
let as = new AtomicSurface('Xx', 1.0, beta, new OccupationDomain('Xx1', odAsym))
qc.setAtomicSurface('Xx1a', as)
